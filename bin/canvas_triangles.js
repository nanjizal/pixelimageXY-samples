...
function pixelimage_algo_TriPixel_fillTriangle(pixelImage,ax,ay,bx,by,cx,cy,color,hasHit,hasUndo) {
	if(hasUndo == null) {
		hasUndo = false;
	}
	if(hasHit == null) {
	...
	return pixelimage_algo_TriPixel_fillTriUnsafe(pixelImage,ax,ay,bx,by,cx,cy,color,hasHit,hasUndo);
}
function pixelimage_algo_TriPixel_fillTriUnsafe(pixelImage,ax,ay,bx,by,cx,cy,color,hasHit,hasUndo) {
	if(hasUndo == null) {
		hasUndo = false;
	}
	if(hasHit == null) {
	...
	if(hasUndo) {
		...
		while(_g < _g1) {
			...
			while(_g2 < _g3) {
				...
				if(pixelImage.useMask && pixelImage.mask != null) {
					var this1 = pixelImage.mask;
...
var pixelimage_$samples_pixelimage_$canvas_Triangles = function() {
	this.canvasSetup = new htmlHelper_canvas_CanvasSetup();
	this.begin();
	this.drawGrid();
	var hits = this.drawAlphaTriangle(this.pixelImage);
	var hit4 = hits[4];
	var hit3 = hits[3];
...
pixelimage_$samples_pixelimage_$canvas_Triangles.__name__ = true;
pixelimage_$samples_pixelimage_$canvas_Triangles.prototype = {
	begin: function() {
	...
	,drawAlphaTriangle: function(p) {
		...
		out.push(pixelimage_algo_TriPixel_fillTriangle(p,100 + 0 * gap,900,300 + 0 * gap,1200,500 + 0 * gap,1000,a_0,hasHit,hasUndo));
		var hasHit = true;
		var hasUndo = true;
		if(hasUndo == null) {
			hasUndo = false;
		...
		out.push(pixelimage_algo_TriPixel_fillTriangle(p,100 + gap,900,300 + gap,1200,500 + gap,1000,a_1,hasHit,hasUndo));
		var hasHit = true;
		var hasUndo = true;
		if(hasUndo == null) {
			hasUndo = false;
		...
		out.push(pixelimage_algo_TriPixel_fillTriangle(p,100 + 2 * gap,900,300 + 2 * gap,1200,500 + 2 * gap,1000,a_2,hasHit,hasUndo));
		var hasHit = true;
		var hasUndo = true;
		if(hasUndo == null) {
			hasUndo = false;
		...
		out.push(pixelimage_algo_TriPixel_fillTriangle(p,100 + 3 * gap,900,300 + 3 * gap,1200,500 + 3 * gap,1000,a_3,hasHit,hasUndo));
		var hasHit = true;
		var hasUndo = true;
		if(hasUndo == null) {
			hasUndo = false;
		...
		out.push(pixelimage_algo_TriPixel_fillTriangle(p,100 + 4 * gap,900,300 + 4 * gap,1200,500 + 4 * gap,1000,a_4,hasHit,hasUndo));
		return out;
	}
};
function pixelimage_$samples_pixelimage_$canvas_Triangles_main() {
	new pixelimage_$samples_pixelimage_$canvas_Triangles();
}
...
pixelimage_$samples_pixelimage_$canvas_Triangles_main();
