...
HX_DEFINE_STACK_FRAME(_hx_pos_ef286ac402a95910_33_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/home/nanjizal/haxe/versions/779b005/std/cpp/_std/sys/io/FileOutput.hx",33,0x48e19a7c)
HX_LOCAL_STACK_FRAME(_hx_pos_ef286ac402a95910_37_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/home/nanjizal/haxe/versions/779b005/std/cpp/_std/sys/io/FileOutput.hx",37,0x48e19a7c)
HX_LOCAL_STACK_FRAME(_hx_pos_ef286ac402a95910_44_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/home/nanjizal/haxe/versions/779b005/std/cpp/_std/sys/io/FileOutput.hx",44,0x48e19a7c)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_ef286ac402a95910_33_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_ef286ac402a95910_37_writeByte)
HXDLIN(  37)		try {
...
int FileOutput_obj::writeBytes(::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_ef286ac402a95910_44_writeBytes)
HXDLIN(  44)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
