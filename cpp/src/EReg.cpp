...
HX_DEFINE_STACK_FRAME(_hx_pos_a7b0190587fef990_28_new,"EReg","new",0x8b859e81,"EReg.new","/home/nanjizal/haxe/versions/779b005/std/cpp/_std/EReg.hx",28,0x4f1e924d)
HX_LOCAL_STACK_FRAME(_hx_pos_a7b0190587fef990_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","/home/nanjizal/haxe/versions/779b005/std/cpp/_std/EReg.hx",98,0x4f1e924d)
...
void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_a7b0190587fef990_28_new)
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_a7b0190587fef990_98_replace)
...
HXLINE( 124)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_4,1);
            							}
            							else {
...
HXLINE( 131)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_5,1);
            							}
            							else {
